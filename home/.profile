...
export GOROOT="$HOME/.gimme/versions/go1.11.1.linux.amd64"
export N_PREFIX="$HOME/.local/share"
export PATH="$HOME/.local/bin:$HOME/.basher/bin:$HOME/.pyenv/bin:$HOME/.pyenv/shims:$HOME/.rbenv/bin:$HOME/.rbenv/shims:$HOME/.npm/bin:$HOME/.cargo/bin:$HOME/.gimme/versions/go1.11.1.linux.amd64/bin:$GOPATH/bin:$HOME/.config/composer/vendor/bin:$HOME/.nimble/bin:$PATH:$HOME/.local/opt/android/platform-tools"
